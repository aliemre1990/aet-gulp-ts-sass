...
/**
 * 
 * @param {{prodMode:boolean,dontCopyVendor:boolean,configuration:Configuration}} options
 * @class
...
Controller.prototype.construct = function () {
    ...
    this.allScriptFiles = Array.prototype
        .concat(this.libraryScriptFiles, this.standaloneLibraryScriptFiles, this.moduleScriptFiles, this.layoutModuleScriptFiles);
