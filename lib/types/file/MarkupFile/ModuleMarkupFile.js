 ...
 */
function ModuleMarkupFile(filePath, configuration, watchMode, prodMode) {
...
ModuleMarkupFile.prototype.getFullContent = function () {
    let content = '';
...
ModuleMarkupFile.prototype.create = function () {
    return new Promise((resolve, reject) => {
        console.log(`Creating marukp file: File path: ${this.filePath}`);

        let content = this.getFullContent();
...
ModuleMarkupFile.prototype.setReferences = function (content) {
