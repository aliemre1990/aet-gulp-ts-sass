 ...
 */
function ModuleMarkupFile(filePath, configuration, watchMode) {
...
ModuleMarkupFile.prototype.getFullContent = function (prodMode) {
    let content = '';
...
ModuleMarkupFile.prototype.create = function (prodMode) {
    return new Promise((resolve, reject) => {
        ...
        let content = this.getFullContent(prodMode);
