...
StandaloneLibraryEntryStyleFile.prototype.getOutputPath = function () {
    return path.join(this.configuration.outputDirectories.standaloneStyleLibraries, this.getLibraryName()) + '.css';
}
StandaloneLibraryEntryStyleFile.prototype.getLibraryName = function () {
    if (path.dirname(this.filePath) === this.configuration.inputDirectories.standaloneStyleLibraries) // if single file library
