    ...
    */
    ...
    function setDependenciesRecursively(layoutModuleMarkupFile, bag) {
        ...
        if (layoutModuleConfiguration) {
            ...
            if (!bag.additionalStylereferencesSet) {
                if (layoutModuleConfiguration && layoutModuleConfiguration.additionalStyleReferences) {
                    bag.additionalStyleReferencesSet = true;
                    bag.additionalStyleReferences.push(...layoutModuleConfiguration.additionalStyleReferences);
                } else if (layoutModuleConfiguration && layoutModuleConfiguration.additionalStyleReferences === null)
                    bag.additionalStyleReferencesSet = true;
            }

            if (!bag.additionalScriptReferencesSet) {
                if (layoutModuleConfiguration && layoutModuleConfiguration.additionalScriptReferences) {
                    bag.additionalScriptReferencesSet = true;
                    bag.additionalScriptReferences.push(...layoutModuleConfiguration.additionalScriptReferences);
                } else if (layoutModuleConfiguration && layoutModuleConfiguration.additionalScriptReferences)
                    bag.additionalScriptReferencesSet = true;
            }
    ...
    for (let moduleMarkupFile of this.moduleMarkupFiles) {
        ...
        let bag = {
            ...
            additionalStyleReferences: [],
            additionalStyleReferencesSet: false,
            additionalScriptReferences: [],
            additionalScriptReferencesSet: false
        };
        ...
        if (moduleConfiguration && moduleConfiguration.additionalStyleReferences) {
            bag.additionalStyleReferencesSet = true;
            bag.additionalStyleReferences.push(...moduleConfiguration.additionalStyleReferences);
        } else if (moduleConfiguration && moduleConfiguration.additionalStyleReferences === null)
            bag.additionalStyleReferencesSet = true;

        if (moduleConfiguration && moduleConfiguration.additionalScriptReferences) {
            bag.additionalScriptReferencesSet = true;
            bag.additionalScriptReferences.push(...moduleConfiguration.additionalScriptReferences);
        } else if (moduleConfiguration && moduleConfiguration.additionalScriptReferences)
            bag.additionalScriptReferencesSet = true;
        ...
        moduleMarkupFile.vendorScriptFiles = bag.vendorScriptFiles;
        moduleMarkupFile.vendorStyleFiles = bag.vendorStyleFiles;
        moduleMarkupFile.additionalStyleReferences = bag.additionalStyleReferencesSet;
        moduleMarkupFile.additionalScriptReferences = bag.additionalScriptReferences;
