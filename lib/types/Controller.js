 ...
 * @constructor
 */
function Controller(configurationPath, prodMode, dontCopyVendor, watchMode) {
...
Controller.prototype.construct = function () {
    ...
    this.moduleConfigurationFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.modules), ['.json'])
        .map(x => new ModuleConfigurationFile(x, this.configuration, this.watchMode));
    ...
    this.layoutModuleConfigurationFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.layoutModules), ['.json'])
        .map(x => new LayoutModuleConfigurationFile(x, this.configuration, this.watchMode));
     ...
     * 
     */
    this.libraryScriptFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.libraryScripts), ['.ts'])
        .map(x => new LibraryScriptFile(x, this.configuration, this.watchMode));

    this.standaloneScriptLibraryScriptFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.standaloneScriptLibraries), ['.ts'])
        .map(x => {
            if (path.dirname(path.dirname(x)) === path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.standaloneScriptLibraries) &&
                ...
                return new StandaloneLibraryEntryScriptFile(x, this.configuration, this.watchMode);
                ...
                return new StandaloneLibraryDependencyScriptFile(x, this.configuration, this.watchMode);
        });

    this.moduleScriptFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.modules), ['.ts'])
        .map(x => new ModuleScriptFile(x, this.configuration, this.watchMode));

    this.layoutModuleScriptFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.layoutModules), ['.ts'])
        .map(x => new LayoutModuleScriptFile(x, this.configuration, this.watchMode));
    this.watchMode
    ...
    */
    this.libraryStyleFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.libraryStyles), ['.scss'])
        .map(x => new LibraryStyleFile(x, this.configuration, this.watchMode));
    ...
    this.standaloneStyleLibraryStyleFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.standaloneStyleLibraries), ['.scss'])
        .map(x => {
            if (path.dirname(path.dirname(x)) === path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.standaloneStyleLibraries) &&
                ...
                return new StandaloneLibraryEntryStyleFile(x, this.configuration, this.watchMode);
                ...
                return new StandaloneLibraryDependencyStyleFile(x, this.configuration, this.watchMode);
        });
    ...
    this.moduleStyleFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.modules), ['.scss'])
        .map(x => new ModuleStyleFile(x, this.configuration, this.watchMode));
    ...
    this.layoutModuleStyleFiles = helper.findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.layoutModules), ['.scss'])
        .map(x => new LayoutModuleStyleFile(x, this.configuration, this.watchMode));
    ...
    this.templateMarkupFiles = helper
        .findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.markupTemplates), ['.html'])
        .map(x => new TemplateMarkupFile(x, this.configuration, this.watchMode));

    /**
     * 
     */
    this.layoutModuleMarkupFiles = helper
        .findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.layoutModules), ['.html'])
        .map(x => {

            let mf = new LayoutModuleMarkupFile(x, this.configuration, this.watchMode);
            this.layoutModules[mf.getModuleName()] = mf;
            return mf;
        });
    ...
    this.moduleMarkupFiles = helper
        .findFilesRecursively(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.modules), '.html', false, true)
        .map(x => {
            let mf = new ModuleMarkupFile(x, this.configuration, this.watchMode);
            let moduleName = mf.getModuleName();
            this.modules[moduleName] = mf;
...
Controller.prototype.watch = function () {
    ...
    let moduleScriptWatcher = gulp
        .watch(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.modules) + '/**/*.ts');
    ...
    let moduleMarkupWatcher = gulp
        .watch(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.modules) + '/**/*.html')
    let layoutModuleScriptWatcher = gulp
        .watch(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.layoutModules) + '/**/*.ts');
    ...
    let layoutModuleMarkupWatcher = gulp
        .watch(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.layoutModules) + '/**/*.html');
    let libraryScriptWatcher = gulp
        .watch(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.libraryScripts) + '/**/*.ts');
    ...
    let standaloneScriptLibraryWatcher = gulp
        .watch(path.join(this.configuration.projectDirectory, this.configuration.sourceDirectories.standaloneScriptLibraries) + '/**/*.ts');
