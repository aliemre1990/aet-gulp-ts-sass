 ...
 * @constructor
 */
function Controller(configurationPath, prodMode, dontCopyVendor) {
    ...
    */
    ...
    this.layoutModuleMarkupFiles = helper
        ...
        .map(x => {
            ...
            let mf = new LayoutModuleMarkupFile(x, this.configuration);
    ...
    this.moduleMarkupFiles = helper
        ...
        .map(x => {
            let mf = new ModuleMarkupFile(x, this.configuration);
            this.modules[mf.getModuleName()] = mf;
            return mf;
        });
